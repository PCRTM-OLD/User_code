...
PROGRAM FWD_SIMU_SAMPLE
  ...
  REAL(SINGLE)                :: TIMESUM, TIMEX, DTIME, TARRAY(2), del
...
!!$  GEOMETRY%PSFC    = 1003.25  ! HPA    SURFACE PRESSURE
!!$  GEOMETRY%SATANG  = 10.0      ! DEGREE
!!$  GEOMETRY%POBS    = 0.005    ! HPA    OBSERVATION PRESSURE

  GEOMETRY%PSFC    = 960.50824   !1013.0! HPA    SURFACE PRESSURE
  GEOMETRY%SATANG  = 0.697755!30.0!56.60787  ! DEGREE
  GEOMETRY%POBS    = 0.005     ! HPA    OBSERVATION PRESSURE
